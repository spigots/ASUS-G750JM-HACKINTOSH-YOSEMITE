 ...
 *
 * Disassembly of iASLU3PJbR.aml, Mon Feb 16 21:50:54 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001470C (83724)
 *     Revision         0x02
 *     Checksum         0x1E
 *     OEM ID           "_ASUS_"
 ...
 */
DefinitionBlock ("iASLU3PJbR.aml", "DSDT", 2, "_ASUS_", "Notebook", 0x00000012)
{
    /*
     ...
     * required for each:
     */
    External (_SB_.PCI0.GFX0.AINT, MethodObj)    // Warning: Unresolved method, guessing 1 arguments
    External (_SB_.PCI0.GFX0.DWBL, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    ...
    External (_SB_.PCI0.GFX0.OPTS, MethodObj)    // Warning: Unresolved method, guessing 2 arguments
    External (_SB_.PCI0.GFX0.OWAK, MethodObj)    // Warning: Unresolved method, guessing 2 arguments
    External (_SB_.PCI0.GFX0.SWHD, MethodObj)    // Warning: Unresolved method, guessing 1 arguments
    External (_SB_.PCI0.GFX0.UPBL, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    ...
    External (_SB_.PCI0.PEG0.PEGP.DWBL, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    External (_SB_.PCI0.PEG0.PEGP.EPON, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    External (_SB_.PCI0.PEG0.PEGP.UPBL, MethodObj)    // Warning: Unresolved method, guessing 0 arguments
    ...
    External (_SB_.PCI0.GFX0.PBCC, UnknownObj)
    External (_SB_.PCI0.GFX0.PBCM, UnknownObj)
    External (_SB_.PCI0.GFX0.PBDI, UnknownObj)
    External (_SB_.PCI0.GFX0.PBMX, UnknownObj)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x7AB0DC18, 0x02B2)
            ...
            Device (LPCB)
            {
                ...
                Device (LDRC)
                {
                    ...
                    Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                    {
                        ...
                        Add (GPBS, 0x0100, IO1M)
                        Add (GPBS, 0x0100, IO1X)
                        ...
                        Add (GPBS, 0x0200, IO2M)
                        Add (GPBS, 0x0200, IO2X)
                        ...
                        Add (GPBS, 0x0300, IO3M)
                        Add (GPBS, 0x0300, IO3X)
                        Return (BUF0)
                    }
                }
                ...
                Device (ADBG)
                {
                    ...
                    Method (PUTD, 1, Serialized)
                    {
                        ...
                        Store (0x3FFF, Local4)
                        Store (Local0, PPDT)
                        ShiftRight (XOr (PPST, 0x80), 0x03, Local3)
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y13._BAS, RBR0)  // _BAS: Base Address
                ...
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y15._BAS, SNR0)  // _BAS: Base Address
                Store (SRMB, SNR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y16._BAS, MBR0)  // _BAS: Base Address
                ShiftLeft (MHBR, 0x0F, MBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y17._BAS, DBR0)  // _BAS: Base Address
                ShiftLeft (DIBR, 0x0C, DBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y18._BAS, EBR0)  // _BAS: Base Address
                ShiftLeft (EPBR, 0x0C, EBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y19._BAS, XBR0)  // _BAS: Base Address
                ShiftLeft (PXBR, 0x1A, XBR0)
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y19._LEN, XSZ0)  // _LEN: Length
    ...
    Scope (_GPE)
    {
        ...
        Method (TBAC, 0, NotSerialized)
        {
            ...
            While (One)
            {
                If (LAnd (LAnd (LNotEqual (RDCC, 0xFFFFFFFF), LEqual (PSD3, Zero)), LNotEqual (
                    SBUS, 0xFF)))
                {
                    Break
                }
    ...
    Scope (_SB)
    {
        ...
        Device (ATKD)
        {
            ...
            Method (WMNB, 3, NotSerialized)
            {
                ...
                If (LEqual (Local0, 0x53545344))
                {
                    If (LEqual (IIA0, 0x00060023))
                    {
                        ...
                        If (LEqual (FSTA, 0x03))
                        {
                            And (^^PCI0.LPCB.EC0.STA8 (Zero), 0x03, Local0)
                        }
                    ...
                    If (LEqual (IIA0, 0x00120044))
                    {
                        If (And (^^PCI0.LPCB.EC0.EPWS, 0x06))
                        {
                            ...
                            Else
                            {
                                ...
                                Else
                                {
                                    Add (B1B2(^^PCI0.LPCB.EC0.B0R0,^^PCI0.LPCB.EC0.B0R1), ^^PCI0.LPCB.EC0.B1R1, Local1)
                                }
                            }
                    ...
                    If (LEqual (IIA0, 0x00120047))
                    {
                        If (And (^^PCI0.LPCB.EC0.EPWS, 0x06))
                        {
                            ...
                            Else
                            {
                                ...
                                Else
                                {
                                    Add (B1B2(^^PCI0.LPCB.EC0.B0D0,^^PCI0.LPCB.EC0.B0D1), ^^PCI0.LPCB.EC0.B0D1, Local1)
                                }
                            }
                    ...
                    If (LEqual (IIA0, 0x00120049))
                    {
                        If (And (^^PCI0.LPCB.EC0.EPWS, 0x06))
                        {
                            ...
                            Else
                            {
                                ...
                                Else
                                {
                                    Add (B1B2(^^PCI0.LPCB.EC0.B0F0,^^PCI0.LPCB.EC0.B0F1), ^^PCI0.LPCB.EC0.B0F1, Local1)
                                }
                            }
            ...
            Method (PSTC, 1, Serialized)
            {
                ...
                Store (Arg0, SLMT)
                Subtract (CPUP, Arg0, \_PR.CPU0._PPC)
                While (One)
                {
                    Store (TCNT, _T_0)
                    If (LEqual (_T_0, 0x08))
            ...
            Method (SCDG, 1, NotSerialized)
            {
                ...
                Add (CALB, Multiply (0x0100, ToInteger (Arg0)), CA1M)
                Store (Zero, Local2)
                Store (One, Local3)
                Store (CA1M, Local1)
    ...
    Scope (_SB.ATKD)
    {
        ...
        Method (GBST, 2, NotSerialized)
        {
            ...
            Store (RTC3, Local0)
            ShiftLeft (Local0, 0x08, Local0)
            Add (Local0, RTC2, Local0)
            ShiftLeft (Local0, 0x08, Local0)
            Add (Local0, RTC1, Local0)
            Store (Local0, BOT2)
            Return (Zero)
        }
    }
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Method (STBR, 0, Serialized)
        {
            ...
            If (Local1)
            {
                ...
                If (LLess (MSOS (), OSW8))
                {
                    ...
                    Divide (Multiply (Local4, 0x64), 0xFF, , Local5)
                    Store (Local5, BRTL)
                    Store (Local4, LCDB)
                }
                Else
                ...
                Name (TMP2, Zero)
                Name (LCD0, Zero)
                If (LEqual (^^^GFX0.PBMX, Zero))
                {
                    Store (0x02, ^^^GFX0.PBMX)
                    If (LEqual (^^^GFX0.PBMX, 0x02))
                    {
                        Store (Zero, Local0)
                        While (LAnd (LAnd (^^^GFX0.PBCC, 0xFF), LLess (Local0, 0x05)))
                        {
                            Increment (Local0)
                            Sleep (One)
                        }

                        If (LEqual (And (^^^GFX0.PBCM, 0x02), Zero))
                        {
                            Multiply (BRTL, 0x0A, TMP1)
                            ShiftLeft (TMP1, 0x08, TMP2)
                            Or (TMP2, LCD0, TMP1)
                            Store (TMP1, ^^^GFX0.PBDI)
                            Store (0x86100000, ^^^GFX0.PBCM)
                            Sleep (0x02)
                        }

                        Store (Zero, ^^^GFX0.PBMX)
                        Return (One)
                    }
                }
        ...
        Method (SMBW, 5, Serialized)
        {
            ...
            If (LLessEqual (Local2, 0x03E8))
            {
                ...
                If (LEqual (Arg0, WRWD))
                {
                    Store(ShiftRight(Arg4,8), T2B1) Store(Arg4, T2B0)
                }
                ...
                Else
                {
                    ...
                    If (Local0)
                    {
                        If (And (^^^^ATKD.WAPF, One))
                        {
                            ...
                            {
                                Store (WRST, Local0)
                                Or (Local0, ShiftLeft (BRST, One), Local0)
                                Increment (Local0)
    ...
    Scope (_SB.PCI0)
    {
        Device (RESC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (BUF0, \_SB.PCI0.RESC._Y1A._BAS, PTB0)  // _BAS: Base Address
                Store (PTAB, PTB0)
                CreateDWordField (BUF0, \_SB.PCI0.RESC._Y1A._LEN, PTLN)  // _LEN: Length
                If (LEqual (PTAB, Zero))
                {
                    Store (Zero, PTLN)
                }
